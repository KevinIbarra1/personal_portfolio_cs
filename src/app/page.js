...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white">
      ...
      <section
        id="testimonials"
        className="py-20 lg:py-28 bg-gradient-to-br from-slate-900/40 via-blue-950/30 to-slate-950 scroll-mt-24 relative overflow-hidden"
      >
        {/* Background decorative elements */}
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-900/20 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-indigo-900/20 to-transparent rounded-full blur-3xl" />
        ...
        <div className="mx-auto max-w-7xl px-6 relative">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="mt-4 text-lg text-slate-300 max-w-2xl mx-auto">
              Feedback from clients and colleagues who&apos;ve experienced my
              work
            </p>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={i}
                className="relative bg-slate-800/60 backdrop-blur-sm rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-slate-700/50 hover:border-slate-600 animate-on-scroll hover-glow"
                ...
                <div className="absolute -top-4 left-8">
                  <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center shadow-lg">
                    <svg
                      ...
                      aria-hidden
                    >
                      <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4V21h-9.983zM0 21v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849H9.983V21H0z" />
                    </svg>
                  </div>
                </div>

                <blockquote className="relative mt-6">
                  <p className="text-slate-200 leading-relaxed text-lg font-medium mb-8">
                    &ldquo;{t.quote}&rdquo;
                  </p>

                  <footer className="flex items-center gap-5">
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 shadow-lg flex items-center justify-center">
