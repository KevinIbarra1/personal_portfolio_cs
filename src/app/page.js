      ...
      <svg className="w-full h-full" viewBox="0 0 696 316" fill="none" preserveAspectRatio="xMidYMid slice">
        {paths.map((path) => (
          <m.path
            ...
            initial={{ pathLength: 0.18, pathOffset: (path.id * 0.028) % 1, opacity: 0 }}
            animate={{ pathOffset: [(path.id * 0.028) % 1, (path.id * 0.028) % 1 + 1], opacity: [0, 1, 1, 0] }}
            transition={{
...
function CheckIcon({ className = '' }) {
  return (
    <svg className={`flex-shrink-0 ${className}`} fill="currentColor" viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
...
function SectionLabel({ children }) {
  return (
    <m.p variants={fadeUp} className="text-blue-400 text-xs font-semibold tracking-widest uppercase mb-4">
      {children}
    </m.p>
  );
}
      ...
      <div className="min-h-screen bg-[#060912] text-white selection:bg-blue-500/30 selection:text-white">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <m.div initial="hidden" animate="show" variants={stagger} className="flex flex-col mt-4">
              ...
              <m.div initial="hidden" animate="show" variants={fadeUp} className="mt-8">
                <button
                  onClick={() => scrollTo('contact')}
        ...
        <section id="home" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0">
            <FloatingPaths position={1}  color="rgb(96, 165, 250)" />  {/* blue-400  — ascending  */}
            <FloatingPaths position={-1} color="rgb(167, 139, 250)" /> {/* violet-400 — descending */}
          </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center pt-16">
            <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }}>
                      ...
                      <span key={wordIndex} className="inline-block mr-[0.25em] last:mr-0">
                        {word.split('').map((letter, letterIndex) => (
                          <m.span
                            ...
                            transition={{
                              delay: line.delay + wordIndex * 0.05 + letterIndex * 0.015,
                              type: 'spring',
                              stiffness: 200,
                              damping: 28,
                            }}
              ...
              <m.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.9, delay: 1.1, ease: [0.25, 0.4, 0.35, 0.8] }}
              ...
              >
                ...
                <div className="group relative bg-gradient-to-b from-white/10 to-black/10 p-px rounded-2xl backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  >
                    <span className="opacity-90 group-hover:opacity-100 transition-opacity">Start a Project</span>
        ...
        <section className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="text-center mb-14">
              <SectionLabel>Who I Work With</SectionLabel>
              <m.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Built for real businesses
              </m.h2>
              <m.p variants={fadeUp} className="text-slate-400 text-lg max-w-lg mx-auto leading-relaxed">
                Whether you&rsquo;re getting started or ready to upgrade, I build websites that match where your business is headed.
              </m.p>
            </m.div>
        ...
        <section className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-16 lg:gap-20 items-center">
              ...
              <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger}>
                <SectionLabel>Why It Matters</SectionLabel>
                <m.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight">
                  Your website is your best salesperson — is it doing its job?
                </m.h2>
                <m.p variants={fadeUp} className="text-slate-400 leading-relaxed mb-4">
                  It works 24 hours a day, never takes a day off, and reaches every potential client who searches for what you do. A well-built website doesn&rsquo;t just look good — it builds trust, answers questions, and moves visitors toward reaching out.
                </m.p>
                <m.p variants={fadeUp} className="text-slate-400 leading-relaxed">
                  A website that looks outdated or is difficult to use sends the wrong message. Visitors leave, and your competitors get the business instead.
                </m.p>
              </m.div>

              <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="flex flex-col gap-4">
                {[
                  {
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-white font-medium mb-1 text-[15px]">{item.title}</h3>
                      <p className="text-slate-400 text-sm leading-relaxed">{item.desc}</p>
                    </div>
                  </m.div>
                ))}
        ...
        <section id="services" className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="text-center mb-14">
              ...
              <m.p variants={fadeUp} className="text-slate-400 text-lg max-w-lg mx-auto leading-relaxed">
                Each project is custom-built to fit your business, your brand, and your goals.
              </m.p>
            </m.div>
        ...
        <section id="process" className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="text-center mb-14">
              ...
              <m.p variants={fadeUp} className="text-slate-400 text-lg max-w-lg mx-auto leading-relaxed">
                No confusion, no surprises. I keep things simple so you always know what&rsquo;s happening and what&rsquo;s next.
              </m.p>
            </m.div>
              ...
              {STEPS.map((step, i) => (
                <m.div key={step.number} variants={fadeUp} className="relative">
                  ...
                  <div className="w-10 h-10 rounded-xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center mb-5">
                    <span className="text-blue-400 font-mono text-xs font-semibold">{step.number}</span>
                  </div>
        ...
        <section id="work" className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="text-center mb-14">
              ...
              <m.p variants={fadeUp} className="text-slate-400 text-lg max-w-lg mx-auto leading-relaxed">
                A few examples of what I&rsquo;ve shipped. Every project is different, but the standard is always the same.
              </m.p>
            </m.div>
              ...
              {PROJECTS.map((project) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-6">
                    <p className="text-blue-400 text-xs font-semibold tracking-widest uppercase mb-2">{project.category}</p>
        ...
        <section className="py-24 border-t border-white/[0.05]">
          <div className="max-w-6xl mx-auto px-5 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <m.div
                initial="hidden" whileInView="show" viewport={vp} variants={fadeLeft}
              ...
              >
                ...
                <m.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight">
                  You&rsquo;re getting a developer who actually cares about your results
                </m.h2>
                <m.p variants={fadeUp} className="text-slate-400 leading-relaxed mb-4">
                  I&rsquo;m Kevin, a full-stack developer based in Puerto Rico. I&rsquo;ve spent years building web applications for companies ranging from startups to enterprise — and I&rsquo;ve seen firsthand what separates a website that converts from one that just sits there.
                </m.p>
                <m.p variants={fadeUp} className="text-slate-400 leading-relaxed mb-10">
                  I started offering web design services for businesses because I kept seeing great businesses held back by a poor online presence. I build websites that are fast, clean, and designed to generate real results — not just look good on a screen.
                </m.p>

                <m.div variants={stagger} className="grid grid-cols-3 gap-6 pt-8 border-t border-white/[0.06]">
                  {[
        ...
        <section id="faq" className="py-24 border-t border-white/[0.05]">
          <div className="max-w-2xl mx-auto px-5 sm:px-6">
            <m.div initial="hidden" whileInView="show" viewport={vp} variants={stagger} className="text-center mb-14">
              ...
              <m.p variants={fadeUp} className="text-slate-400 text-lg leading-relaxed">
                Straightforward answers to what most people ask before getting started.
              </m.p>
            </m.div>
            ...
            >
              {FAQS.map((faq, i) => (
                <m.div key={i} variants={fadeUp} className="border border-white/[0.06] rounded-xl overflow-hidden">
                  <button
                    onClick={() => setOpenFaq(openFaq === i ? null : i)}
                    className="w-full flex items-start justify-between p-6 text-left hover:bg-white/[0.02] transition-colors gap-4 group"
                  >
                    <span className="text-white font-medium text-[15px] leading-snug">{faq.q}</span>
                    <span
                    ...
                    {openFaq === i && (
                      ...
                      >
                        <div className="px-6 pb-6 border-t border-white/[0.04]">
                          <p className="pt-4 text-slate-400 text-sm leading-relaxed">{faq.a}</p>
                        </div>
                      </m.div>
                    )}
                  </AnimatePresence>
          ...
          <div className="max-w-4xl mx-auto px-5 sm:px-6">
            ...
            >
              ...
              <div className="relative">
                ...
                <m.h2 variants={fadeUp} className="text-4xl sm:text-5xl font-bold text-white mb-5 leading-tight">
                  Ready to build your website?
                </m.h2>
                <m.p variants={fadeUp} className="text-slate-400 text-lg leading-relaxed max-w-xl mx-auto mb-10">
                  Tell me about your business and what you need. I&rsquo;ll get back to you within 24 hours and we&rsquo;ll figure out the best next step together.
                </m.p>

                <m.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <a
        ...
        <footer className="border-t border-white/[0.05] py-8">
          <div className="max-w-6xl mx-auto px-5 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="mailto:kevin.ibarra@upr.edu" className="text-slate-600 hover:text-slate-300 text-sm transition-colors">
                Email
              </a>
              <a href="https://www.linkedin.com/in/kevin-ibarra1/" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-slate-300 text-sm transition-colors">
                LinkedIn
              </a>
              <a href="https://github.com/KevinIbarra1" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-slate-300 text-sm transition-colors">
                GitHub
              </a>
            </div>
          </div>
